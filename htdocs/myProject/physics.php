 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="physics.php"</script>';  
           }  
      }  
      else  
      {  
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center">Physics Books</h3><br />  
                <?php  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="physics.php?action=add&id=<?php echo $row["physics_id"]; ?>">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td>Tk. <?php echo $values["item_price"]; ?></td>  
                               <td><a href="physics.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
