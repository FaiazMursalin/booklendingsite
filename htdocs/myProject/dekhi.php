 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="dekhi.php"</script>';  
           }  
      }  
      else  
      {  
   ...
   <link href="css/main.css" rel="stylesheet"/>
	...
	<div id="templatemo_menu">
    	<ul>
			...
			<li>
				<form action="show_search.php"  method="post" class="form-inline md-form form-sm mt-0">
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center"Searched Book/s</h3><br />  
                <?php
					if(isset($_POST['search']) ){
						$s = $_POST['search'];
						//$p = $_POST['pass'];
						$sql = "select distinct book_id, lender_email, book_name, author, categories, original_price from book where book.Book_name= '$s' ";
						$result= mysqli_query($conn, $sql);
							if(mysqli_num_rows($result) > 0) {  
								while($row = mysqli_fetch_array($result)){  
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="dekhi.php?action=add&id=<?php echo $row["book_id"]; ?>">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                              
                               <h4 class="text-info"><?php echo $row["book_name"]; ?></h4>  
                               <h4 class="text-danger">Tk. <?php echo $row["original_price"]; ?></h4>  
                               
                               <input type="hidden" name="hidden_name" value="<?php echo $row["book_name"]; ?>" />  
                               <input type="hidden" name="hidden_price" value="<?php echo $row["original_price"]; ?>" />  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td>Tk.<?php echo $values["item_price"]; ?></td>  
                               <td><a href="dekhi.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
