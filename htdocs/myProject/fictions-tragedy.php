 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="fictions-tragedy.php"</script>';  
           }  
      }  
      else  
      {  
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center" ><b>Fictional Tragedy Books</b></h3><br />  
                <?php  
                $query = "select book.lender_email, fictions.book_name, tragedy.author, book.categories, 
		   tragedy.price from ((fictions inner join tragedy on fictions.book_name = tragedy.book_name) inner join book on book.book_name = tragedy.book_name)";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="fictions-tragedy.php?action=add&id=<?php echo $row["book_id"]; ?>">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td>Tk.<?php echo $values["item_price"]; ?></td>  
                               <td><a href="fictions-tragedy.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
