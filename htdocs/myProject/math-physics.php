 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="math-physics.php"</script>';  
           }  
      }  
      else  
      {  
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center">Math & Physics Corelated Books</h3><br />  
                <?php  
                $query = "select book.lender_email, math.book_name, physics.author, book.categories, 
		   physics.price from ((math inner join physics on math.book_name = physics.book_name) inner join book on book.book_name = physics.book_name)";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="chemistry.php?action=add&id=<?php echo $row["math_id"]; ?>">  
